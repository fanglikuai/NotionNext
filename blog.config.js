...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '方立', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '后端开发人员，努力学习中💪', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fanglikuai.xyz/', // 网站地址
